...
import { require_classnames, useBootstrapPrefix, useIsRTL } from "./ThemeProvider-DS0FnZs3.js";
import { NavbarContext_default, SelectableContext_default, addEventListener_default, contains, dataAttr, listen_default, makeEventKey, ownerDocument, qsa, require_browser, useEventCallback as useEventCallback$1, useEventCallback$1 as useEventCallback, useIsomorphicEffect_default$1 as useIsomorphicEffect_default, useMergedRefs_default, useMounted, usePrevious, useUncontrolled, useWindow } from "./querySelectorAll-nkEJC5Ps.js";
import { require_jsx_runtime } from "./jsx-runtime-BDej0IFL.js";
...
function usePopper(referenceElement, popperElement, _ref = {}) {
	let { enabled = true, placement = "bottom", strategy = "absolute", modifiers = EMPTY_MODIFIERS } = _ref, config = _objectWithoutPropertiesLoose$4(_ref, _excluded$4);
...
function useDropdownMenu(options = {}) {
	const context$1 = (0, import_react.useContext)(DropdownContext_default$1);
	const [arrowElement, attachArrowRef] = useCallbackRef();
	const hasShownRef = (0, import_react.useRef)(false);
	const { flip: flip$1, offset: offset$1, rootCloseEvent, fixed = false, placement: placementOverride, popperConfig = {}, enableEventListeners = true, usePopper: shouldUsePopper = !!context$1 } = options;
	const show = (context$1 == null ? void 0 : context$1.show) == null ? !!options.show : context$1.show;
	if (show && !hasShownRef.current) hasShownRef.current = true;
	const handleClose = (e) => {
		context$1?.toggle(false, e);
	};
	const { placement, setMenu, menuElement, toggleElement } = context$1 || {};
	...
	const metadata = {
		...
		toggle: context$1 == null ? void 0 : context$1.toggle,
...
function DropdownMenu$1(_ref) {
	let { children, usePopper: usePopperProp = true } = _ref, options = _objectWithoutPropertiesLoose$3(_ref, _excluded$3);
...
var Button$1 = /* @__PURE__ */ import_react.forwardRef((_ref, ref) => {
	let { as: asProp, disabled } = _ref, props = _objectWithoutPropertiesLoose$2(_ref, _excluded$2);
...
function Dropdown$1({ defaultShow, show: rawShow, onSelect, onToggle: rawOnToggle, itemSelector = `* [${dataAttr("dropdown-item")}]`, focusFirstItemOnShow, placement = "bottom-start", children }) {
	...
	const context$1 = (0, import_react.useMemo)(() => ({
		toggle,
		placement,
		show,
		menuElement,
