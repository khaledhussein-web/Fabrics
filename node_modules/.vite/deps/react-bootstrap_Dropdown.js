	...
	*/
	(function() {
		...
		function parseValue(arg) {
			...
			if (Array.isArray(arg)) return classNames$8.apply(null, arg);
		...
		if (typeof module !== "undefined" && module.exports) {
			classNames$8.default = classNames$8;
			module.exports = classNames$8;
		} else if (typeof define === "function" && typeof define.amd === "object" && define.amd) define("classnames", [], function() {
			return classNames$8;
		});
		else window.classNames = classNames$8;
	})();
}) });
...
var useCommittedRef_default$1 = useCommittedRef$1;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
	let { enabled = true, placement = "bottom", strategy = "absolute", modifiers = EMPTY_MODIFIERS } = _ref, config = _objectWithoutPropertiesLoose$5(_ref, _excluded$4);
...
*/
function contains(context$2, node) {
	if (context$2.contains) return context$2.contains(node);
	if (context$2.compareDocumentPosition) return context$2 === node || !!(context$2.compareDocumentPosition(node) & 16);
}
...
function useClickOutside(ref, onClickOutside = noop$2, { disabled, clickTrigger = "click" } = {}) {
	...
	const handleMouseCapture = (0, import_react.useCallback)((e) => {
		...
		(0, import_warning$1.default)(!!currentTarget, "ClickOutside captured a close event but does not have a ref to compare it to. useClickOutside(), should be passed a ref that resolves to a DOM node");
	...
	(0, import_react.useEffect)(() => {
		...
		if ("ontouchstart" in doc.documentElement) mobileSafariHackListeners = [].slice.call(doc.body.children).map((el) => listen_default(el, "mousemove", noop$2));
		return () => {
...
var _excluded$3 = ["children", "usePopper"];
...
function useDropdownMenu(options$1 = {}) {
	const context$2 = (0, import_react.useContext)(DropdownContext_default$1);
	const [arrowElement, attachArrowRef] = useCallbackRef();
	const hasShownRef = (0, import_react.useRef)(false);
	const { flip: flip$1, offset: offset$1, rootCloseEvent, fixed = false, placement: placementOverride, popperConfig = {}, enableEventListeners = true, usePopper: shouldUsePopper = !!context$2 } = options$1;
	const show = (context$2 == null ? void 0 : context$2.show) == null ? !!options$1.show : context$2.show;
	if (show && !hasShownRef.current) hasShownRef.current = true;
	const handleClose = (e) => {
		context$2?.toggle(false, e);
	};
	const { placement, setMenu, menuElement, toggleElement } = context$2 || {};
	...
	const metadata = {
		...
		toggle: context$2 == null ? void 0 : context$2.toggle,
...
function DropdownMenu$1(_ref) {
	let { children, usePopper: usePopperProp = true } = _ref, options$1 = _objectWithoutPropertiesLoose$4(_ref, _excluded$3);
...
function useDropdownToggle() {
	...
	const { show = false, toggle = noop, setToggle, menuElement } = (0, import_react.useContext)(DropdownContext_default$1) || {};
...
var Button$1 = /* @__PURE__ */ import_react.forwardRef((_ref, ref) => {
	let { as: asProp, disabled } = _ref, props = _objectWithoutPropertiesLoose$3(_ref, _excluded$2);
...
var DropdownItem$1 = /* @__PURE__ */ import_react.forwardRef((_ref, ref) => {
	let { eventKey, disabled, onClick, active, as: Component = Button_default$1 } = _ref, props = _objectWithoutPropertiesLoose$2(_ref, _excluded$1);
...
function Dropdown$1({ defaultShow, show: rawShow, onSelect, onToggle: rawOnToggle, itemSelector = `* [${dataAttr("dropdown-item")}]`, focusFirstItemOnShow, placement = "bottom-start", children }) {
	...
	const context$2 = (0, import_react.useMemo)(() => ({
		toggle,
		placement,
		show,
		menuElement,
...
function useUncontrolled(props, config) {
	return Object.keys(config).reduce(function(result, fieldName) {
		var _extends2;
		var _ref = result, defaultValue = _ref[defaultKey(fieldName)], propsValue = _ref[fieldName], rest = _objectWithoutPropertiesLoose$1(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
var DropdownHeader = /* @__PURE__ */ import_react.forwardRef(({ className, bsPrefix, as: Component = "div", role = "heading",...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		ref,
		className: (0, import_classnames$6.default)(className, bsPrefix),
		role,
		...props
	});
});
...
var DropdownItem = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, className, eventKey, disabled = false, onClick, active, as: Component = Anchor_default,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		...
		...dropdownItemProps,
		ref,
		className: (0, import_classnames$5.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
	});
});
...
var DropdownMenu = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, className, align, rootCloseEvent, flip: flip$1 = true, show: showProps, renderOnMount, as: Component = "div", popperConfig, variant,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		...
		className: (0, import_classnames$3.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
	});
});
...
var Button = /* @__PURE__ */ import_react.forwardRef(({ as, bsPrefix, variant = "primary", size, active = false, disabled = false, className,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(tagName, {
		...
		ref,
		disabled,
		className: (0, import_classnames$2.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled && "disabled")
	});
});
...
var DropdownToggle = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, split, className, childBsPrefix, as: Component = Button_default,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		className: (0, import_classnames$1.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
		...toggleProps,
		...props
	});
});
